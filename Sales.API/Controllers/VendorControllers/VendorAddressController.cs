...
namespace Sales.API.Controllers.VendorControllers
{
    ...
    public class VendorAddressController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResponseDto>> Post(VendorAddressDto newObj)
        {
            try
            {
        ...
        [HttpPatch]
        public async Task<ActionResult<ApiResponseDto>> Patch(VendorAddressDto patchObj)
        {
            try
            {
